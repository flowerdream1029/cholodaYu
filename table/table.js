...
// 里面的匿名函数是立即执行的，fn函数也是立即执行的，括号法是立即执行操作
//  var fn = function (a) {
//  	alert(a);
//  }(function () {
//  	return 4;
...
// 测试数据属性，利用object.defineProperty来修改属性特性
//  var person = {};
...
//  类数组
//  这种情况下，对象的属性名是从1开始的，相当于数组中的序号，
//  在进行访问的时候，使用[]来访问对应属性的值
//  var a = {1:23};
//  alert(a[1]); // 23
//  var i = 0;
//  while(i < 10){
...
//  //  var s=Array.prototype.join.call(a,"+"); // a+b+c
//  //  var s1=Array.prototype.slice.call(a,0); // ["a","b","c"]
//  //  var s2=Array.prototype.map.call(a,function(x){return x.toUpperCase();}); 
//  // ["A","B","C"]
...
//  var o={x:1}; // 待绑定的对象
//  var g=f.bind(o); // 通过调用g(x)来调用f(x)
//  g(2);


//  var sortHeight = function() {
//  	//  var tabNode = document.getElementByTagName("table")[0];
